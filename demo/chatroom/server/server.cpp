...
typedef vector<string> UserVector;
typedef map<string, Connection> OnlineUserMap;

UserVector userVec;
OnlineUserMap userMap;
int main()
{
	...
	//Init
	userVec.push_back("rensq");
	userVec.push_back("shibojun");
	userVec.push_back("lijin");
